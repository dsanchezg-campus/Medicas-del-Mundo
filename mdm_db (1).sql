...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-04-2026 a las 12:00:39
...
INSERT INTO `bloque` (`id_bloque`, `id_categoria`, `titulo`, `descripcion`, `texto`, `orden`, `id_madre`, `fecha_actualizacion`, `icono`) VALUES
(5, 10, 'nAUTICO', 'Cancion maria', '(Coro)María mírame, María mírameSi tú me miras, Él también me miraráMadre mía, mírameDe la mano llévameMuy cerca de ÉlQue ahí me quiero quedar. (Verso)No tengo miedo, no, no tengo miedoPorque sé que tú me llevas de la manoAunque el mundo me diga que estoy locoY que el camino es difícil y lejano.(Coro)María mírame, María mírameSi tú me miras, Él también me miraráMadre mía, mírameDe la mano llévameMuy cerca de ÉlQue ahí me quiero quedar. ', 0, NULL, '2026-03-23', NULL);
